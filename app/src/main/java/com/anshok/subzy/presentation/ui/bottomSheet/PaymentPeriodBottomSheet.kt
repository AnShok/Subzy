...
import com.anshok.subzy.databinding.FragmentPaymentPeriodBottomSheetBinding
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class PaymentPeriodBottomSheet(private val onPeriodSelected: (Int, String) -> Unit) :
    BottomSheetDialogFragment() {

    private lateinit var binding: FragmentPaymentPeriodBottomSheetBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        binding = FragmentPaymentPeriodBottomSheetBinding.inflate(inflater, container, false)
        return binding.root
    }
