...
import com.anshok.subzy.databinding.FragmentNotificationReminderBottomSheetBinding
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class NotificationReminderBottomSheet(private val onOptionSelected: (String) -> Unit) :
    BottomSheetDialogFragment() {

    private val binding: FragmentNotificationReminderBottomSheetBinding by viewBinding(CreateMethod.INFLATE)
