...
sealed interface AddSubSearchState {
    ...
    data class LocalOnly(val logos: List<Logo>) : AddSubSearchState // ✅ Показ только локальных данных
    data class Success(val logos: List<Logo>) : AddSubSearchState    // ✅ Комбинированный успех (локальные + API)
